...
.. toctree::
   :caption Control constructs Table of Contents
   :maxdepth 3

   topic-5-1-ifs.rst
   topic-5-2-if-else.rst
   topic-5-3-else-ifs.rst
   ...
   topic-5-26-FRQstringScrambleA.rst
   topic-5-27-ConsumerReviewLab.rst
